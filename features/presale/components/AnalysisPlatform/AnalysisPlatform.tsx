    ...
    <div className="bg-black text-white py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-8 sm:mb-12 leading-tight font-DM Sans">
          Analysis platform for Bitcoin, Ethereum and Altcoins. <br className="hidden sm:inline" /> Supported by Advanced AI Technology.
        </h1>

        <div className="relative w-full max-w-6xl mx-auto mt-8 sm:mt-12 p-4 sm:p-8 bg-[#000000C2] rounded-lg shadow-2xl overflow-hidden
                    flex flex-col items-center justify-center
                    min-h-[600px] sm:min-h-[700px] lg:min-h-[400px]
                    lg:block">

          <div className="relative w-full h-auto mb-8 mx-auto
            ...
            <div className="relative w-full h-auto max-h-[300px] sm:max-h-[400px] lg:max-h-none">
              <img src="/ai-chip.gif" alt="AI Chip" className="w-full h-full object-contain z-[1]" />
          ...
          <div className="relative w-full h-[300px] sm:h-[400px] mx-auto
                          lg:absolute lg:right-0 lg:top-1/2 lg:-translate-y-1/2 lg:w-[55%] lg:h-full
                          flex items-center justify-center p-2 sm:p-4">
            <img src="./icons/crypto-chart.svg" alt="Crypto Chart" className="w-full h-full object-contain" />
            ...
            <div className="absolute bottom-2 left-2 w-16 h-16
              ...
              <img src="./icons/bitcoin-logo.svg" alt="Bitcoin Logo" className="w-full h-full object-contain" />
            </div>
            ...
            <div className="absolute top-2 right-2 w-14 h-14
              ...
              <img src="./icons/up-arrows.svg" alt="Upward Arrows" className="w-full h-full object-contain" />
            </div>
          </div>
